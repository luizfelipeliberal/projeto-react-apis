import { CardStyle, Left, Number, Name, Details, Type, Back, Pokemon, Right, TypeInside, TypeName, Capturar } from './CardStyle';
...
export function Card(props) {
  ...
  return (
    <CardStyle style={{backgroundColor: cardColor}} >
      ...
      <Right>
        <Capturar onClick={(()=> props.addPokemon(props.pokemon))}>Capturar Pokemon!</Capturar>
        <Back src={back} alt="" />
